  ...
  return (
    <div className="relative z-20 flex h-full flex-col items-center justify-center gap-8 overflow-y-auto px-6 py-10">
      <div className="flex items-center gap-5">
        <img src="/na-club-logo.png" alt="" className="h-16 w-16" />
        <div className="text-left">
          <h1 className="display text-6xl leading-none tracking-[0.06em] text-gold">
            NA CAI 67 SPEED
          </h1>
          <p className="mt-1 text-xs uppercase tracking-[0.35em] text-muted">
            20 seconds · pump your arms · beat the board
          </p>
        </div>
      </div>
